...
namespace GeckoMapTester
{
    ...
    public class TCPGecko
    {
        ...
        public void Dump(UInt32 startdump, UInt32 enddump, Stream[] saveStream)
        {
            ...
            if (GeckoMapTester.ValidMemory.rangeCheckId(startdump) != GeckoMapTester.ValidMemory.rangeCheckId(enddump))
            {
                enddump = GeckoMapTester.ValidMemory.ValidAreas[GeckoMapTester.ValidMemory.rangeCheckId(startdump)].high;
            }

            if (!GeckoMapTester.ValidMemory.validAddress(startdump)) return;
        ...
        */
        ...
        {
            if (!GeckoMapTester.ValidMemory.validAddress(address))
            {
                return 0;
            }
